...
public class Client implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae){
        try{
        String out= text.getText();//With this you can take out value written in the textfield
    ...
    public static void main(String[] args){
        ...
        try {
            Socket s = new Socket("127.0.0.1",5001); //local host ka address or server  ki location
